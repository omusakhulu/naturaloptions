...
# Natural Options - PostgreSQL Deployment Script
# Server: 185.181.8.53
...
echo -e "${GREEN}═══════════════════════════════════════════════════════════════${NC}"
echo -e "${GREEN}    Natural Options - PostgreSQL Deployment${NC}"
...
echo -e "\n${YELLOW}📤 Uploading files to server...${NC}"

# Direct SSH/SCP without password (already configured)
...
echo -e "\n${GREEN}═══════════════════════════════════════════════════════════════${NC}"
echo -e "${GREEN}✅ DEPLOYMENT COMPLETE WITH POSTGRESQL!${NC}"
echo -e "${GREEN}═══════════════════════════════════════════════════════════════${NC}"
echo -e ""
...
echo -e "  • Database: naturaloptions_db"
echo -e "  • User: naturaloptions_user"
echo -e "  • Connection Pooling: Enabled (10 connections)"
echo -e ""
echo -e "${YELLOW}Next Steps:${NC}"
echo -e "1. SSH to server: ssh root@${SERVER_IP}"
echo -e "2. Update API keys in: /var/www/naturaloptions/.env"
echo -e "3. Configure WooCommerce webhooks"
echo -e "4. Test integrations"
echo -e ""
echo -e "${YELLOW}Monitoring:${NC}"
echo -e "  • View logs: ssh root@${SERVER_IP} 'pm2 logs'"
echo -e "  • Check status: ssh root@${SERVER_IP} '/var/www/naturaloptions/monitor.sh'"
