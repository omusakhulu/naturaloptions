...
export default function SalesOrderPage() {
  ...
  const [columns, setColumns] = useState([
    ...
    { key: 'shipStatus', label: 'Shipping Status', visible: true },
    { key: 'qtyRemaining', label: 'Quantity Remaining', visible: true },
  ...
  const filtered = useMemo(() => {
    ...
    if (q) {
      list = rows.filter(r =>
        ['date', 'orderNo', 'customer', 'contact', 'location', 'status', 'shipStatus', 'addedBy']
    ...
    <div className='p-8 space-y-4'>
      ...
      <div className='bg-white border rounded shadow p-4 relative'>
        <div className='flex flex-wrap items-center gap-3 mb-3'>
          ...
          <a
            href={`/${lang}/apps/sell/sales-order/add`}
            className='ml-auto bg-indigo-600 hover:bg-indigo-700 text-white rounded px-4 py-2 text-sm'
          >
            + Add Sales Order
          </a>
          <div className='ml-3'>
