...
export default function AllSalesPage() {
  ...
  const [columns, setColumns] = useState([
    ...
    { key: 'serviceType', label: 'Types of service', visible: true }
  ])
  ...
  const filtered = useMemo(() => {
    ...
    if (q) {
      list = rows.filter(r =>
        [
          'date','invoiceNo','customer','contact','location','paymentStatus','paymentMethod','shippingStatus','serviceType'
    ...
    <div className='p-8 space-y-4'>
      ...
      <div className='bg-white border rounded shadow p-4 relative'>
        <div className='flex items-center justify-between mb-3'>
          <h3 className='font-medium'>All sales</h3>
