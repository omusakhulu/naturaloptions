      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            label: 'BOQ (Bills)',
            icon: 'tabler-circle',
            href: '/apps/projects/boq/list'
          },
          {
            label: 'Cost Reports',
            icon: 'tabler-circle',
            href: '/apps/projects/cost-reports/list'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            label: 'Assignments',
            icon: 'tabler-circle',
            href: '/apps/logistics/assignments'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            icon: 'tabler-circle',
            href: 'https://massappealdesigns.co.ke',
            target: '_blank',
            suffix: <i className='tabler-external-link text-xl' />
          },
          {
