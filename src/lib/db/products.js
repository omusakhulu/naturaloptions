...
if (!process.env.NEXT_PUBLIC_DATABASE_URL) {
  console.warn('⚠️ NEXT_PUBLIC_DATABASE_URL environment variable is not set. Products will not be saved to database.')
}
...
export async function saveProduct(productData) {
  ...
  if (!process.env.NEXT_PUBLIC_DATABASE_URL) {
    console.warn('⚠️ Skipping product save: NEXT_PUBLIC_DATABASE_URL not configured')
...
export async function saveProducts(productsData) {
  // Skip if DATABASE_URL is not configured
  if (!process.env.NEXT_PUBLIC_DATABASE_URL) {
    console.warn('⚠️ Skipping products save: NEXT_PUBLIC_DATABASE_URL not configured')
...
export async function getAllProducts() {
  // Skip if DATABASE_URL is not configured
  if (!process.env.NEXT_PUBLIC_DATABASE_URL) {
    console.warn('⚠️ Skipping products fetch: NEXT_PUBLIC_DATABASE_URL not configured')
...
export async function getProductByWooId(wooId) {
  // Skip if DATABASE_URL is not configured
  if (!process.env.NEXT_PUBLIC_DATABASE_URL) {
    console.warn('⚠️ Skipping product fetch: NEXT_PUBLIC_DATABASE_URL not configured')
...
export async function deleteProduct(wooId) {
  // Skip if DATABASE_URL is not configured
  if (!process.env.NEXT_PUBLIC_DATABASE_URL) {
    console.warn('⚠️ Skipping product delete: NEXT_PUBLIC_DATABASE_URL not configured')
...
export async function clearAllProducts() {
  // Skip if DATABASE_URL is not configured
  if (!process.env.NEXT_PUBLIC_DATABASE_URL) {
    console.warn('⚠️ Skipping products clear: NEXT_PUBLIC_DATABASE_URL not configured')
