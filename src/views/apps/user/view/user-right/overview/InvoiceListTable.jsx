...
const invoiceStatusObj = {
  // Default statuses
  draft: { color: 'primary', icon: 'tabler-pencil' },
  ...
  downloaded: { color: 'info', icon: 'tabler-download' },

  // Fallback for any other status
  default: { color: 'secondary', icon: 'tabler-file-invoice' }
}

// Helper function to get status with fallback
const getInvoiceStatus = status => {
  if (!status) return invoiceStatusObj.default
  const normalizedStatus = status.toLowerCase()

  return invoiceStatusObj[normalizedStatus] || invoiceStatusObj.default
}
