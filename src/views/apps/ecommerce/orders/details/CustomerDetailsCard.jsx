    ...
    <Card>
      <CardContent className='flex flex-col gap-6'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <div className='flex flex-col'>
            <Typography color='text.primary' className='font-medium'>
              {typeof orderData?.customer === 'object' ? orderData?.customer?.name : orderData?.customer}
            </Typography>
            <Typography>Customer ID: #{orderData?.customer?.id || '47389'}</Typography>
          </div>
        </div>
        <div className='flex items-center gap-3'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <Typography>Mobile: {orderData?.billingAddress.phone}</Typography>
          <Typography>Stand Number: {orderData?.boothNumber || '-'}</Typography>
          <Typography>VAT Number: {orderData?.vatNumber || '-'}</Typography>
        </div>
      </CardContent>
    </Card>
  )
