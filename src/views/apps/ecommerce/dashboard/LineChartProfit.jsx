...
const LineChartProfit = ({ profitData = [0, 19, 7, 27, 15, 40], totalProfit = '624k', growthPercent = '+8.2%' }) => {
  // Vars
  const series = [{ data: profitData }]
  // Hooks
    ...
    <Card>
      ...
      <CardContent className='flex flex-col gap-3 pbs-3'>
        ...
        <div className='flex items-center justify-between flex-wrap gap-x-4 gap-y-0.5'>
          ...
          <Typography variant='body2' color={growthPercent.startsWith('+') ? 'success.main' : 'error.main'}>
            {growthPercent}
          </Typography>
        </div>
      </CardContent>
