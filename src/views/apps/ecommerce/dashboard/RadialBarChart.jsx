...
const RadialBarChart = ({ totalExpenses = '82.5k', expensePercent = 78, expenseDiff = '$21k Expenses more than last month' }) => {
  ...
  return (
    <Card>
      <CardHeader title={totalExpenses} subheader='Expenses' className='pbe-0' />
      <CardContent className='flex flex-col gap-3 items-center'>
        <AppReactApexCharts type='radialBar' height={148} width='100%' options={options} series={[expensePercent]} />
