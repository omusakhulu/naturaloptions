    ...
    () => [
      ...
      columnHelper.accessor('invoiceStatus', {
        ...
        cell: ({ row }) => (
          ...
          >
            <CustomAvatar skin='light' color={invoiceStatusObj[row.original.status || row.original.invoiceStatus]?.color || 'default'} size={28}>
              <i className={classnames('bs-4 is-4', invoiceStatusObj[row.original.status || row.original.invoiceStatus]?.icon || 'tabler-help')} />
            </CustomAvatar>
          </Tooltip>
        )
      }),
