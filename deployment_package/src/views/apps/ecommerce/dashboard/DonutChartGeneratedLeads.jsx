...
const BarChartRevenueGrowth = ({ categorySales = [32, 41, 41, 70], totalLeads = '4,350', growthPercent = '+15.8%', categories = ['Electronic', 'Sports', 'Decor', 'Fashion'] }) => {
  const series = categorySales
  // Hook
        ...
        <div className='flex flex-col justify-between'>
          ...
          <div className='flex flex-col items-start'>
            ...
            <div className='flex items-center gap-1'>
              <i className={`tabler-chevron-${growthPercent.startsWith('+') ? 'up' : 'down'} text-${growthPercent.startsWith('+') ? 'success' : 'error'} text-xl`}></i>
              <Typography color={growthPercent.startsWith('+') ? 'success.main' : 'error.main'} component='span'>
                {growthPercent}
              </Typography>
            </div>
          </div>
