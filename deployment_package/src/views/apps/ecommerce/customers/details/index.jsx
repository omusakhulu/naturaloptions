...
// Vars
const tabContentList = (customerData, customerOrders) => ({
...
const CustomerDetails = ({ customerData, customerId, customerOrders = [] }) => {
  return (
    <Grid container spacing={6}>
      ...
      <Grid size={{ xs: 12, md: 4 }}>
        <CustomerLeftOverview customerData={customerData} customerOrders={customerOrders} />
      </Grid>
      <Grid size={{ xs: 12, md: 8 }}>
        <CustomerRight tabContentList={tabContentList(customerData, customerOrders)} />
      </Grid>
    </Grid>
  )
}
