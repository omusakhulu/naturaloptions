    ...
    <div className='h-screen flex flex-col bg-gray-50 overflow-hidden'>
      ...
      {showReceipt && lastSale && (
        <POSReceipt
          ...
          onPrint={() => {
            // Use browser print with receipt content - thermal receipt 80mm width
            ...
            if (printContent) {
              ...
              printWindow.document.write(`
                ...
                <html>
                <head>
                  <title>Receipt - ${lastSale.saleNumber}</title>
                  <style>
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    ...
                    img { max-height: 40px; width: auto; display: block; margin: 0 auto 8px; }
